	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			<div class="row">
				...
				<p class="secondary">Let's add some additional information about this brand. The information below will help us create a cover to identifiy the brand throughout the site.</p>
			</div>
